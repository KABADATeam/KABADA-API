...
namespace Kabada {
  partial class CashFlow {
    ...
    private void generateWorkbookStylesPartContent(WorkbookStylesPart workbookStylesPart1) {
      ...
      var alis2=new Alignment(){ ShrinkToFit=true };
      var alis3=new Alignment(){ ShrinkToFit=true };
      var alis4=new Alignment(){ ShrinkToFit=true };
      CellFormats cellFormats1 = new CellFormats() { Count = (UInt32Value)3U };
      CellFormat cellFormat2 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)0U, FormatId = (UInt32Value)0U, Alignment=alis2 };
      CellFormat cellFormat3 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)0U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)0U, ApplyBorder = true, Alignment=alis3 };
      CellFormat cellFormat4 = new CellFormat() { NumberFormatId = (UInt32Value)0U, FontId = (UInt32Value)1U, FillId = (UInt32Value)0U, BorderId = (UInt32Value)1U, FormatId = (UInt32Value)0U, ApplyFont = true, ApplyBorder = true, Alignment=alis4 };
